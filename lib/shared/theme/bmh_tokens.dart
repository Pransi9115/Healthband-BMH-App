...
class BMHColors {
  ...
  // A traffic light, read by distance from the range rather than by
  // direction: green inside, amber just outside on either side, red
  // further out on either side. Whether a result is high or low is
  // said in words on the label; the colour answers the simpler and
  // more urgent question of how far off it is.
  static const Color rangeIn   = Color(0xFF22C55E); // inside reference
  static const Color rangeEdge = Color(0xFFFF9500); // borderline, either side
  static const Color rangeOut  = Color(0xFFF01B1B); // outside, either side

  // Kept as aliases so existing call sites keep reading naturally.
  static const Color rangeLow  = rangeOut;
  static const Color rangeHigh = rangeOut;
...
class BMHText {
  ...
  // ── Mono → now Plus Jakarta Sans (Calm Dark) ──────────
  // Was JetBrains Mono. Same sizes/weights/roles everywhere these
  // styles are used (units, captions, pills) — just a calmer,
  // less "terminal" typeface per the Calm Dark reference, with
  // slightly softer letter-spacing to match.
  static TextStyle get monoLg => GoogleFonts.plusJakartaSans(
    fontSize: 11, height: 16/11,
    fontWeight: FontWeight.w600, color: BMHColors.inkMute,
    letterSpacing: 0.06 * 11,
  );
  static TextStyle get monoMd => GoogleFonts.plusJakartaSans(
    fontSize: 10, height: 14/10,
    fontWeight: FontWeight.w600, color: BMHColors.inkMute,
    letterSpacing: 0.08 * 10,
  );
  static TextStyle get monoSm => GoogleFonts.plusJakartaSans(
  ...
  static TextStyle get eyebrow => GoogleFonts.plusJakartaSans(
    fontSize: 10, height: 14/10,
    fontWeight: FontWeight.w600, color: BMHColors.cyan,
