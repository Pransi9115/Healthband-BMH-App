...
//  What the patient takes, and whether they actually took it
//  today. Only supplements marked taken count toward intake,
//  because the blood result reflects what was swallowed, not
//  what was prescribed.
// ─────────────────────────────────────────────────────────
...
class _SupplementsScreenState extends State<SupplementsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final takenToday = _svc.takenCount(_day);
        ...
        Expanded(child: ListView(
          ...
          children: [
            if (items.isEmpty)
              ...
              Text(
                '$takenToday of ${items.length} marked taken '
                '${_isToday ? "today" : "on $_dayLabel"}. Only what you '
                'tick counts toward intake.',
                style: BMHText.bodySm.copyWith(
      ...
      child: Row(children: [
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: taken
                ? BMHColors.sGut : Colors.transparent,
